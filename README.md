...
```bash
git clone https://github.com/PoliticianCut/itops-agent-platform-919.git
cd itops-agent-platform-919
npm install
npm start
```
...
[![CI](https://github.com/PoliticianCut/itops-agent-platform-919/actions/workflows/ci.yml/badge.svg)](https://github.com/PoliticianCut/itops-agent-platform-919/actions/workflows/ci.yml)
...
- [🐛 提交 Bug](https://github.com/PoliticianCut/itops-agent-platform-919/issues/new?template=bug_report.yml)
- [💡 提出新功能](https://github.com/PoliticianCut/itops-agent-platform-919/issues/new?template=feature_request.yml)
- [📝 改进文档](https://github.com/PoliticianCut/itops-agent-platform-919/issues/new?template=docs_update.yml)
- [🔒 报告安全问题](SECURITY.md)
...
<!-- Last updated: 2026-06-06 16:17:05 -->
